...
class CourseOutlineTool(Tool):
    """Tool for retrieving the outline (lesson list) of a course"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: title, link, and complete lesson list with lesson numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
