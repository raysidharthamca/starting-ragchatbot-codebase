...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        """Get course outline (title, link, lessons) for a given course name using semantic matching"""
        import json
        ...
        return {
            ...
            "lessons": [{"lesson_number": l["lesson_number"], "lesson_title": l["lesson_title"]} for l in lessons]
        }
